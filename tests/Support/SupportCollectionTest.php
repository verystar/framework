...
use Very\Support\Collection;
use Very\Contracts\Support\Jsonable;
use Very\Contracts\Support\Arrayable;
...
class SupportCollectionTest extends TestCase
{
    ...
    {
        $item1 = m::mock('Very\Contracts\Support\Arrayable');
        $item1->shouldReceive('toArray')->once()->andReturn('foo.array');
        $item2 = m::mock('Very\Contracts\Support\Arrayable');
